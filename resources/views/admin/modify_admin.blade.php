        ...
        <div class="col-md-5 border-right">
            <div class="p-3 py-5">
                <div class="d-flex justify-content-between align-items-center mb-3">
                    <h4 class="text-right">Modify Admin Details</h4>
                </div>
                <div class="row mt-2">

              <div> <div class="col-md-6"><label class="labels">ID</label><input type="text" class="form-control" placeholder="ID" value=""></div></div> 
                ...
                <div class="row mt-3">
                    ...
                    <div class="col-md-12"><label class="labels">Password</label><span>******</span> | <a href="/password">Change Password</a></div>
